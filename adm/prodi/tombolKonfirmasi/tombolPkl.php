...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nim'])) {
    ...
    $sql = "UPDATE dbo.serahan_pkl SET status_pengumpulan_serahan_pkl = ? WHERE NIM = ?";
    ...
    if ($status === 'terverifikasi'){
        $sqlConfirm ="UPDATE dbo.serahan_pkl SET keterangan_pengumpulan_serahan_pkl = 'pkl diterima' WHERE NIM = ?";

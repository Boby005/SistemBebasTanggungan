                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mhs, pk.status_pengumpulan_serahan_pkl AS status
                                                    FROM dbo.mahasiswa m
                                                    JOIN dbo.serahan_pkl pk ON m.nim = pk.nim";
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="tombolKonfirmasi/tombolPkl.php" method="POST">

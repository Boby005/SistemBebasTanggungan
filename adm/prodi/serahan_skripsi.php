                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mhs, pk.status_pengumpulan_serahan_skripsi AS status
                                                    FROM dbo.mahasiswa m
                                                    JOIN dbo.serahan_skripsi pk ON m.nim = pk.nim";
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="tombolKonfirmasi/tombolSerahanSkripsi.php" method="POST">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_serahan_skripsi.pdf`;

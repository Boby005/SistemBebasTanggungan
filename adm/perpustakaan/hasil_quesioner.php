        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <p></p>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">DATA HASIL QUESIONER</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mhs, pk.status_pengumpulan_hasil_quesioner AS status
                                                    FROM dbo.mahasiswa m
                                                    JOIN dbo.hasil_quesioner pk ON m.nim = pk.nim";
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_hasil_quesioner.pdf" ?>"
                                                            data-pdf="../Documents/uploads/hasil_quesioner/<?= $row['nim'] ?>_hasil_quesioner.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="tombolKonfirmasi/tombolHasilQuesioner.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function() {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../../Documents/uploads/hasil_quesioner/${nim}_hasil_quesioner.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_hasil_quesioner.pdf`;

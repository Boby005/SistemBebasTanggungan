        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <p></p>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">DATA HARDCOPY</h1>
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mhs, pk.status_pengumpulan_serahan_hardcopy AS status
                                                    FROM dbo.mahasiswa m
                                                    JOIN dbo.serahan_hardcopy pk ON m.nim = pk.nim";
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_serahan_hardcopy.pdf" ?>"
                                                            data-pdf="../../Documents/uploads/serahan_hardcopy/<?= $row['nim'] ?>_serahan_hardcopy.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="tombolKonfirmasi/tombolHardCopy.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function() {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../../Documents/uploads/serahan_hardcopy/${nim}_serahan_hardcopy.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_serahan_hardcopy.pdf`;

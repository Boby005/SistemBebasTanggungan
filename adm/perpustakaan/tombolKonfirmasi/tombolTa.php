...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.ta_softcopy
            SET status_pengumpulan_ta_softcopy = ?, keterangan_pengumpulan_ta_softcopy = ?
            WHERE nim = ?";
    ...
    if ($stmt && $stmt2) {
        header("Location: ../ta_softcopy.php?message=Status+berhasil+diperbarui!&type=success");
        exit();
    } else {

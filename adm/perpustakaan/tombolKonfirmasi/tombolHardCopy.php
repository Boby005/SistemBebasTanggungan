...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.serahan_hardcopy
            SET status_pengumpulan_serahan_hardcopy = ?, keterangan_pengumpulan_serahan_hardcopy = ?
            WHERE nim = ?";
    ...
    if ($stmt && $stmt2) {
        header("Location: ../serahan_hardcopy.php?message=Status+berhasil+diperbarui!&type=success");
        exit();
    } else {

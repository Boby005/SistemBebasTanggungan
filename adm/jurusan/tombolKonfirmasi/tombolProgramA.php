...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE dbo.program_aplikasi
            SET status_pengumpulan_program_aplikasi = ?, keterangan_pengumpulan_program_aplikasi = ?
            WHERE nim = ?";
    ...
    if ($stmt && $stmt2) {
        header("Location: ../publikasi_j.php?message=Status+berhasil+diperbarui!&type=success");
        exit();
    } else {

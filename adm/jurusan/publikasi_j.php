                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                ...
                                <tbody>
                                    ...
                                    try {
                                        ...
                                        $sql = "SELECT m.nim, m.nama_mhs, pk.status_pengumpulan_publikasi_jurnal AS status
                                                    FROM dbo.mahasiswa m
                                                    JOIN dbo.publikasi_jurnal pk ON m.nim = pk.nim";
                                                ...
                                                <td>
                                                    ...
                                                    <?php elseif (strtolower($row['status']) === 'terverifikasi'): ?>
                                                        <button class="btn btn-info btn-sm edit-data"
                                                            ...
                                                            data-nama-berkas="<?= $row['nim'] . "_publikasi_jurnal.pdf" ?>"
                                                            data-pdf="../Documents/uploads/publikasi_jurnal/<?= $row['nim'] ?>_publikasi_jurnal.pdf"
                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="verifikasiForm" action="tombolKonfirmasi/tombolPublikasiJurnal.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener("click", function() {
                    const nim = this.getAttribute("data-nim");
                    const pdfUrl = `../Documents/uploads/publikasi_jurnal/${nim}_publikasi_jurnal.pdf`;

                    // Update isi modal
                    document.getElementById('nim').value = nim;
                    document.getElementById('namaBerkas').value = `${nim}_publikasi_jurnal.pdf`;
